...
# Image should be scaled to 255
def extract_features_from_image_vec(feature_image, spatial_size=(32, 32),
...
def extract_features_from_images(imgs, color_space='RGB', spatial_size=(32, 32),
        hist_bins=32, orient=9,
        pix_per_cell=8, cell_per_block=2, hog_channel=0,
        spatial_feat=True, hist_feat=True, hog_feat=True):
    ...
    for f in imgs:
        file_features = extract_features_from_image_file(f, color_space,
                spatial_size, hist_bins, orient,
                pix_per_cell, cell_per_block,
                hog_channel, spatial_feat,
                hist_feat, hog_feat)
